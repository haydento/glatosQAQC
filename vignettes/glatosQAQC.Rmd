...
HTML file that may be opened in any web browser.  Optionally, output
...
Files from downloaded receivers (*.vrl) can be selected for inclusion
in the summary by pressing the "Browse" button under "Choose vrl file"
heading.  Once the file selection box opens, the user navigates to the
desired .vrl files and selects one or many receivers by pressing
